...
def update_max():
  global cur_val, cur_max, hour, tvoc_mesaurement, current_time, r_code, max_tvoc, co2_measurement, g_code, max_co2, min_tvoc, last_update, b_code, min_co2, Background_color, Text_color, minute, second, co2_now, label_tvoc, co2_min, co2_max, tvoc_min, tvoc_max, Co2_title, TVOC_title, Last_update, update_time, i2c0, tvoc_0
  if max_co2 == None:
...
def check_for_new_max(cur_val, cur_max):
  global hour, tvoc_mesaurement, current_time, r_code, max_tvoc, co2_measurement, g_code, max_co2, min_tvoc, last_update, b_code, min_co2, Background_color, Text_color, minute, second, co2_now, label_tvoc, co2_min, co2_max, tvoc_min, tvoc_max, Co2_title, TVOC_title, Last_update, update_time, i2c0, tvoc_0
  if cur_val >= cur_max:
    return True
  return False
...
def btnA_wasClicked_event(state):
  global co2_now, label_tvoc, co2_min, co2_max, tvoc_min, tvoc_max, Co2_title, TVOC_title, Last_update, update_time, i2c0, tvoc_0, hour, tvoc_mesaurement, current_time, r_code, max_tvoc, co2_measurement, g_code, max_co2, min_tvoc, cur_val, cur_max, last_update, b_code, min_co2, Background_color, Text_color, minute, second
  Change_color()
