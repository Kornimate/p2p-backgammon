...
We have covered how a player can manipulate their own score, but not if they can manipulate the score of other players. This might be possible by performing an attack with the aim to steal the cookie. % encrypting the results 
