...
[Link to Azure deployed application](https://iotapp-hrg5d4fadhaqdwcz.northeurope-01.azurewebsites.net)<br />
The problem with azure is that if tha application is inactive, azure disables the resources behind it in F1 tier (free tier, always on mode costs 13$ per month :( ). We have a solution for this but if you experience that the applicaiton is not working please can contact me on email: kornimate@gmail.com, or write me on messenger: Kornidesz Máté.
